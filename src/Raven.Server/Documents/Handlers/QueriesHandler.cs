...
namespace Raven.Server.Documents.Handlers
{
    public sealed class QueriesHandler : DatabaseRequestHandler
    {
        ...
        public Task Post()
        {
            return DatabaseQueriesHandlerProcessorForGet.ExecuteAndDispose(new DatabaseQueriesHandlerProcessorForGet(this, HttpMethod.Post));
        }

        [RavenAction("/databases/*/queries", "GET", AuthorizationStatus.ValidUser, EndpointType.Read, DisableOnCpuCreditsExhaustion = true)]
        public Task Get()
        {
            return DatabaseQueriesHandlerProcessorForGet.ExecuteAndDispose(new DatabaseQueriesHandlerProcessorForGet(this, HttpMethod.Get));
        }
