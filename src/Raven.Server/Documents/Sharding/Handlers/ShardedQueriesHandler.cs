...
namespace Raven.Server.Documents.Sharding.Handlers
{
    public sealed class ShardedQueriesHandler : ShardedDatabaseRequestHandler
    {
        ...
        public Task Post()
        {
            return new ShardedQueriesHandlerProcessorForGet(this, HttpMethod.Post).ExecuteAsTaskAsync();
        }

        [RavenShardedAction("/databases/*/queries", "GET")]
        public Task Get()
        {
            return new ShardedQueriesHandlerProcessorForGet(this, HttpMethod.Get).ExecuteAsTaskAsync();
        }
