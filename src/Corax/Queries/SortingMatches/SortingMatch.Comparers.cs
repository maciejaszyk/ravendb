 ...
 unsafe partial struct SortingMatch<TInner>
 {
    ...
    private struct EntryComparerByScore : IEntryComparer, IComparer<UnmanagedSpan>
    {
            ...
            bool descending = false)
        {
            ...
            bool includeScoringToResults = match._sortingDataTransfer.ScoresBuffer != null;
            ...
            for (int i = 0; i < batchResults.Length; i++)
            {
                ...
                else
                {
                    ...
                    if (spatialResults.Length > 0)
                    {
                        ...
                        if (coords.Lat is > -0.0005 and < 0.0005 || coords.Lng is > -0.0005 and < 0.0005)
                            Debugger.Break();
                    }
                }
